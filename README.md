...
or download the <a href="https://oss.sonatype.org/service/local/repositories/releases/content/com/amihaiemil/web/eo-yaml/4.3.1/eo-yaml-4.3.1-jar-with-dependencies.jar">fat</a> jar.
