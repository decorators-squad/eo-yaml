...
or download the <a href="https://oss.sonatype.org/service/local/repositories/releases/content/com/amihaiemil/web/eo-yaml/7.0.8/eo-yaml-7.0.8-jar-with-dependencies.jar">fat</a> jar.
