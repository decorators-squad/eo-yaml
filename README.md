...
or download the <a href="https://oss.sonatype.org/service/local/repositories/releases/content/com/amihaiemil/web/eo-yaml/5.1.5/eo-yaml-5.1.5-jar-with-dependencies.jar">fat</a> jar.
