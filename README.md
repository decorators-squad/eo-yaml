...
or download the <a href="https://oss.sonatype.org/service/local/repositories/releases/content/com/amihaiemil/web/eo-yaml/8.0.4/eo-yaml-8.0.4-jar-with-dependencies.jar">fat</a> jar.
